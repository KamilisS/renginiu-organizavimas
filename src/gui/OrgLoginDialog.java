 ...
 * @author gvt48
 */
public class OrgLoginDialog extends javax.swing.JDialog {
     ...
     */
    public OrgLoginDialog(javax.swing.JFrame parent, boolean modal) {
        super(parent, modal);
        this.parent = parent;
        initComponents();
    }
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        HashMap<String, String> login = new MSSQL().loginOrganiser(this.emailField.getText(), this.pswField.getText());
        if (!login.isEmpty()) {
            
            Session session = new Session();
            session.setLoginType(Session.LOGIN_TYPE_ORGANISER);
            session.setMyID(Integer.parseInt(login.get("id")));
            session.setName(login.get("name") + " " + login.get("surname"));
            session.setMoney(Double.parseDouble(login.get("money")));
            
            this.dispose();
            this.parent.dispose();
            
            OrgMain main = new OrgMain(session);
            Common.center(main);
            main.setTitle("Organizatoriaus sąsaja");
